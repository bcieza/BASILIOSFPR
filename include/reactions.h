...
void sweep_separation_complex_rot_PBCCELL(double deltat, int p1, Fullmol *bases, Complex *ind_com, int *ncross, int **cross_part, int **cross_int, int **cross_rxn, double **traj, double **prob, Parms plist, int *movestat, int *ihome, double *bindrad, double **trajR, double *M, int **Rlist);
...
int get_distance(Fullmol *bases, double **traj, int p1, int p2, double deltat, double bindrad, int *ncross, int **crosspart, int **crossint, int i1, int i2, int mu, int **cross_rxn, int *ihome, double iter, double Rmax, double &sep, double &R1);
int get_distancePBC(Fullmol *bases, double **traj, int p1, int p2, double deltat, double bindrad, int *ncross, int **crosspart, int **crossint, int i1, int i2, int mu, int **cross_rxn, int *ihome, double iter, double Rmax, double &sep, double &R1, Parms &plist);
...
void associate_freelegPBC(int p1,int p2, int mu, int i1, int i2, Fullmol *bases, int **Rlist, int *ihome, Complex *ind_com, Parms &plist);
void associate_translate_measurePBC(int p1,int p2, int mu, int i1, int i2, Fullmol *bases, int **Rlist, int *ihome, Complex *ind_com, Parms &plist);
...
void associate_translate_measurePBCCELLMF(int p1, int p2, int mu, int i1, int i2, Fullmol *bases, int **Rlist, int *ihome, Complex *ind_com, Parms &plist,Protein *wholep);
...
void associate_zsigmaPBCCELL(int p1,int p2, int mu, int i1, int i2, Fullmol *bases, int **Rlist, int *ihome, Complex *ind_com, Parms &plist, double bindrad, int *ncrosscom );
...
void associate_2dclat_3dclat_lipid_sigmaPBCCELL(int p1,int p2, int mu, int i1, int i2, Fullmol *bases, int **Rlist, int *ihome, Complex *ind_com, Parms &plist, double bindrad, int *ncrosscom);
...
void write_protein_iface(ofstream &outfile, Parms &plist, Fullmol *bases, int *Ncopy, int it, Protein *wholep, string *names);
...
void generate_initial_crds(Parms plist, Fullmol *bases, int *Ncopy, Complex *ind_com, double *bindrad, Protein *wholep, int **Rlist,int *rxtype, int *p_home, int howmanylipids, double ***coordcont);
