...
//known as members, can have different types and different lengths. Data structures can be declared in C++ using the following
//Additional information: https://www.tutorialspoint.com/cplusplus/cpp_data_structures.htm
//Added by BASILIO
int main(int argc, char *argv[]) {
//IN int main()...argc, char **argv represent the command line arguments....myprogram.cpp a b (added by BASILIO)
	...
	//One (called tv_sec) is exactly the value that would be returned by time, the time in seconds since 1/1/1970.
	//The other (called tv_usec) is the number of microseconds into that  second.
...
//	read_parms(parmfile, plist); //  write_parms(plist);
	...
	//////////////////////////BASILIO:LOOKING WHAT HAPPEN/////////////////////
	cout<<"This is the Plist.Nprototypes\n"<< plist.Nprotypes <<"\n"<< "This is the number of plist interfacesn\n"<< plist.Nifaces<<endl;
	//////////////////////////////////////////////////////////////////////////////////////////////////////////

	int Nprotypes = plist.Nprotypes; //total distinct protein types, so 9            ///BASILIO: WHY 9???
	int Nifaces = plist.Nifaces; //this is the number of interfaces
	//////////////////////////BASILIO:LOOKING WHAT HAPPEN/////////////////////
	cout<<"This is the Nprototypes\n"<< Nprotypes <<"\n"<< "This is the number of interfacesn\n"<< Nifaces<<endl;
	//////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//it allocates one object of type int and initialized it to value
...
//		Ntotalmol += Ncopy[i];
	...
	// BASILIO: IMPORTANT INFORMATION FOR VECTOR REORIENTATION
	...
	int **Speclist = new int*[Nifaces];// BASILIO: What is the difference between Speclist and numpartners?
...
//	ofstream restart(tname);
	...
	for (i = 0; i < Ntotalmol; i++) {
		//BASILIO:NOTE THAT crosspart[i] is a VECTOR of dimension newsizeoverlap..., but therefore CROSSPART is a MATRIXEs of VECTORS ...
		//WHICH ARE the identity #Col and #Row for this matrix??? #col=molecula identity,
...
//BASILIO: ncross, ncroscom and movestat are VECTORS!! The dimension are Ntotalmol
	...
	//BASILIO: A PROBLEM OF FINDING A MAXIMUM
...
//    DDmatrixcreate(msur2, mnorm2, mpir2, bindrad[2], Dtot, kr[2]/2/bindrad[2], deltat);
	...
	plist.prerot =1;
	//Previous
	//plist.pretrans = trans_prefactor(Temp, nu, scale, crad, wholep[2].Dx);
	//plist.prerot = rot_prefactor(Temp, nu, scale, crad, wholep[2].Drx);
	////////////////////////////////////////////////////////////////////////////////////
...
//		  disassemblyfile <<crosscounter<<endl;
		  ...
		  if(ncross[i]>40){
			  cout<<"EXCEEDED MAX NUMBER OF OVERLAPS!!!"<<endl;
			  cout<<"Protein "<< i << " made a ton of overlaps"<<endl;
		  }
		...
		//BASILIO: WHAT IS ci1 and ci2?
	      */
	      ...
	      if (flag == 1) {
	    	  //ADDED BY BASILIO 19 NOV 2016///
	    	  if (bases[p1].protype == plist.pclath || bases[p2].protype == plist.pclath){
	    	  //if ((ind_com[c1].Dz==0 && ind_com[c2].Dz!=0) || (ind_com[c2].Dz==0 && ind_com[c1].Dz!=0)){
	    		  //if (bases[p1].protype == plist.pclath || bases[p2].protype == plist.pclath){
	    			  cout<<"EUREKA"<<" "<<ind_com[c2].Dx<<c2<<c1<<"  "<<ind_com[c1].Dy<<"BASILIO"<<endl;
	    			  ayudame(p1, p2, bases);
	    		  //}
	    	  }
		// FINISHED ADDITION
	  ...
	  /// BASILIO: I BELIEVE THAT OUR PROBLEM IS HERE ... 16 NOV 2016////
